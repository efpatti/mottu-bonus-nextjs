...
interface VehicleSelectionProps {
  onVehicleSelect?: (vehicle: 'motorcycle' | 'car') => void;
}

export const VehicleSelection = ({ onVehicleSelect }: VehicleSelectionProps) => {
  const [selectedVehicle, setSelectedVehicle] = useState<'motorcycle' | 'car' | null>(null);

  const handleVehicleSelect = (vehicle: 'motorcycle' | 'car') => {
    ...
    <section className="flex flex-col items-center justify-center min-h-screen py-16 px-4 bg-gray-50">
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg text-center">
        ...
        <p className="text-gray-600 mb-8">
          Selecione o tipo de veículo que você utiliza para ver as regras específicas do seu bônus.
        </p>
        ...
        {selectedVehicle && (
          <div className="mt-8 p-4 bg-green-50 rounded-lg border border-green-200">
            <p className="text-green-800 font-medium">
              Veículo selecionado: <span className="font-bold">
